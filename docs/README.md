...
**Step 1.** Download and run the installer: **[VoxBee_Setup_1.0.1.exe](https://github.com/boris-agent007/Voxbee/releases/tag/v1.0.1)**
...
If you encounter issues, please [create an issue](https://github.com/boris-agent007/Voxbee/issues) and include your computer specifications.
...
> **Important:** The software was tested on only one configuration (see [Test Hardware](#️-test-hardware)). Operation on other hardware is not guaranteed. If the software works or doesn't work on your PC — please report in [issues](https://github.com/boris-agent007/Voxbee/issues).
...
Download `VoxBee_Setup_1.0.1.exe` from [Releases](https://github.com/boris-agent007/Voxbee/releases/tag/v1.0.1).
